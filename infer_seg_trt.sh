...
ENGINE_PATH="weights/yolov8n-seg.engine"
INPUT_IMAGE="data/ship/ship1.jpg"
OUTPUT_DIR="output/segmentation_cpp"
# DEVICE_ID="${DEVICE_ID:-0}"
DEVICE_ID=3
BIN_NAME="infer_seg_trt"
...
build_binary() {
  g++ -std=c++17 -O2 infer_seg_trt.cpp -o "$BIN_NAME" \
...
"./$BIN_NAME" \
  "$ENGINE_PATH" \
  "$INPUT_IMAGE" \
  "$OUTPUT_DIR" 0.5 0.5 1 "$DEVICE_ID"
